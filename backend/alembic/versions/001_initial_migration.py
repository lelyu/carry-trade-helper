...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text(
                "ARRAY['EUR/USD', 'GBP/USD', 'USD/JPY', 'USD/CHF', 'AUD/USD', 'USD/CAD', 'NZD/USD', 'USD/CNY', 'USD/HKD']::text[]"
            ),
        ),
    ...
    op.create_table(
        ...
        sa.Column("date", sa.Date(), nullable=False),
        sa.Column("source", sa.String(50), server_default="fred"),
    ...
    op.create_index(
        "idx_chat_messages_user", "chat_messages", ["user_id", "created_at"]
    )

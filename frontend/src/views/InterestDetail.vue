    ...
    <header class="bg-white border-b border-gray-200 shrink-0 z-40">
      <div class="px-4 py-3">
        <div class="flex items-center justify-between">
          <router-link to="/interest" class="text-gray-400 hover:text-gray-600 transition-colors">
    ...
    <main class="flex-1 overflow-y-auto px-4 pt-4 pb-20 md:pb-6">
      <div v-if="currentRate" class="space-y-4">
        <div class="bg-white rounded-lg p-5">
          <div class="text-sm text-gray-400">{{ currentRate.country_code }} &middot; {{ currentRate.currency_code }}</div>

  ...
  <div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
      ...
      <div class="mb-4">
        ...
        <select v-model="localFrequency" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
      ...
      <div class="mb-4">
        <label class="flex items-center">
          <input type="checkbox" v-model="isActive" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
      ...
      <p class="text-gray-600 mb-4">Select the currency pairs you want to track:</p>
      
      <div class="grid grid-cols-2 gap-2">
        <label v-for="pair in availablePairs" :key="pair" class="flex items-center">
          <input 
            type="checkbox" 
            :value="pair" 
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      <p class="text-gray-600 mb-4">Set thresholds for rate change alerts:</p>
...
onMounted(async () => {
  ...
  if (settingsStore.preferences) {
    ...
    if (settingsStore.preferences.alert_thresholds) {
      thresholds.value = {
        rate_change: settingsStore.preferences.alert_thresholds.rate_change || 0.5,
        spread: settingsStore.preferences.alert_thresholds.spread || 10
      }
    }
  }
})
...
const saveEmailPreferences = async () => {
  const result = await settingsStore.updatePreferences({
    email_frequency: localFrequency.value,
...
const showMessage = (success: boolean) => {
  message.value = success ? 'Settings saved successfully!' : 'Failed to save settings'
